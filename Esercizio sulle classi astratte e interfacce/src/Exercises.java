...
public class Exercises {
    ...
    private static void exercise1() {
        System.out.println("\nExercise 1: ");
        // Your code here
        Rectangle rettangolo = new Rectangle(4,7);
        System.out.println(rettangolo.calculateAreaRectangle());
        Circle cerchio = new Circle(5,5);
        System.out.println(cerchio.calculateareaCircle());
    }
    ...
    private static void exercise2() {
        ...
        // Your code here
        Car panda = new Car();
        System.out.println("the car will move " + panda.moveBackward());
        Boat barca = new Boat();
        System.out.println("the boat will move "+ barca.moveForward());
    }
    ...
    private static void exercise3() {
        System.out.println("\nExercise 3: ");
        // Your code here
        Guitar chitarra = new Guitar("Jimmy Hendrix","The Special one");
        System.out.println(chitarra.getName()+ " of the brand "+chitarra.getBrand()+ ", " + chitarra.play());
        Piano pianoforte = new Piano("Millenium","Majestic");
        System.out.println(pianoforte.getName()+ " of the brand "+ pianoforte.getBrand()+ ", "+ pianoforte.play());
    }
}
