...
public class Exercises {
    ...
    private static void exercise2() {
        System.out.println("\nExercise 2: ");
        // Your code here
        System.out.println(ourNumbers.stream().filter(x -> (x % 2) != 0).collect(Collectors.toSet()));
    }
    ...
    private static void exercise4() {
        System.out.println("\nExercise 4");
        //Your code here
        System.out.println(ourNumbers.stream().filter(x -> x % 2 == 0).map(y -> y * 2).collect(Collectors.toSet()));
    }
}
